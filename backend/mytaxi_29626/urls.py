"""mytaxi_29626 URL Configuration
...
admin.site.site_header = "MyTaxi"
admin.site.site_title = "MyTaxi Admin Portal"
admin.site.index_title = "MyTaxi Admin"

# swagger
api_info = openapi.Info(
    title="MyTaxi API",
    default_version="v1",
    description="API documentation for MyTaxi App",
)
